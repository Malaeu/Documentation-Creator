"""
Author : Tadashi Jei
Description: This project automates the generation of user-friendly API documentation in markdown format from OpenAPI specifications (YAML, JSON).
"""
...
st.set_page_config(
    page_title="Generate beautiful, developer-friendly API docs from OpenAPI specs in seconds!  This Markdown generator automates documentation, reduces maintenance, and boosts developer experience. ",
    page_icon="📜",
    layout="wide",
)
...
def render_footer():
    ...
    <div class="footer">
        <p>Made with ❤️ by <a href="https://github.com/tadashijei" target="_blank">TadashiJei</a></p>
    </div>
    """
...
def main():
    ...
    """
    st.markdown("<h1 style='text-align: center;'>Tired of writing API docs?  This project automates generating clear Markdown docs from OpenAPI specs. Improve developer experience & simplify maintenance.</h1>", unsafe_allow_html=True)
